function spelunkBranchImproved(currentPath,currentOrder,currentOptions,currentDistanceTravelled)
...
%% Compute Recursion               
        ...
        % Node names are of their co-ordinates
         ...
         if moreOptimal
               ...
               spelunkBranchImproved(branchPath,branchOrder,branchOptions,branchDist);
         else 
